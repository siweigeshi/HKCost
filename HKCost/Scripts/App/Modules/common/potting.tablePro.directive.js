(function () {
    ...
    function PottingTable($scope, ngTableParams, $element) {
        var tableList = [];
        //构造一个ngtable
        $scope.parentTableParamsPro = new ngTableParams({
            page: 1,    // 当前页数 
            count: 10,    // 每页显示的条数
            ...
            getData: function ($defer, params) {
                ...
                $scope.TableBindPro($defer, params, sortList, function (data) {
                    tableList = data;
                    $scope.loading = false;
                });
            }
    ...
    //定义一个directive的组件
    angular.module('potting.tablePro', [])
    .directive('ngProtable', function () {
        return {
            restrict: 'E',
            templateUrl: 'tablePro.html',
