 ...
 *     }
 */
Ext.define('ExtFrame.view.extEncap.plugin.TreeViewDragDrop', {
    extend: 'Ext.plugin.Abstract',
    alias: 'plugin.treeviewdragdropdiy',

    uses: [
        'ExtFrame.view.extEncap.plugin.ViewDragZone',
        'ExtFrame.view.extEncap.plugin.ViewDropZone'
    ],
    ...
    onViewRender : function(view) {
        ...
        if (me.enableDrag) {
            ...
            me.dragZone = new ExtFrame.view.extEncap.plugin.ViewDragZone(Ext.apply({
                view: view,
        ...
        if (me.enableDrop) {
            me.dropZone = new ExtFrame.view.extEncap.plugin.ViewDropZone(Ext.apply({
                view: view,
                ddGroup: me.dropGroup || me.ddGroup,
                allowContainerDrops: me.allowContainerDrops,
                appendOnly: me.appendOnly,
                isAppentToLeafNode:me.isAppentToLeafNode,
