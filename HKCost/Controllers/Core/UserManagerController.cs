...
namespace HKCost.Controllers.Core
{
    ...
    public class UserManagerController : ApiController
    {
        ...
        private readonly IUserManagerBLL _user;
        public UserManagerController(IUserBLL _bll, IUserManagerBLL _username)
        {
            _service = _bll;
            _user = _username;
        ...
        /// 信息的添加或者修改保存
        /// </summary>
        /// <param name="PostClass">保存的实体对象</param>
        /// <returns></returns>
        ...
        ///批量删除
        /// </summary>
        /// <param name="PostClass">删除实体集合类</param>
        /// <returns></returns>
        [HttpPost]
        ...
        /// </summary>
        /// <returns></returns>
        public object GetUserAllList()
        {
            IList<Base_UserInfo> userList = _service.All();
            return Common.NewtonJsonHelper.Deserialize<object>
                (Common.NewtonJsonHelper.Serialize(userList,
                new List<string>() { "Orgs", "Roles", "UserName" }), null);
        }
    }
}
